    ...
    <form action="{{ route('admin.projects.store') }}" method="POST" enctype="multipart/form-data" class="bg-white rounded-lg shadow p-6 space-y-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div>
                ...
                <input type="text" name="sub_name" value="{{ old('sub_name') }}" placeholder="e.g. Ministry of Health National Healthcare Facility" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent">
        ...
        <div>
            ...
            <p class="text-sm text-gray-500 mb-2">Label/value rows shown on the project's own page — Consultant, Category, Contract Type, Completion, Duration, or anything else you want.</p>
