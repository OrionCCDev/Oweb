...
<div class="max-w-2xl mx-auto">
    <h2 class="text-2xl font-bold mb-6">Edit Sector: {{ $sector->name }}</h2>
    <form action="{{ route('admin.sectors.update', $sector) }}" method="POST" enctype="multipart/form-data" class="bg-white rounded-lg shadow p-6 space-y-6">
        @csrf
        @method('PATCH')
        <div>
